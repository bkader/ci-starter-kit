...
class Route
{
	...
	public static function context($name, $controller = null, $options = array())
	{
		...
		// Added by Kader Bouyakoub <https://github.com/bkader>
		$filter = array();
		(isset($options['before'])) && $filter['before'] = $options['before'];
		(isset($options['after'])) && $filter['after'] = $options['after'];
		...
		self::any($name.'/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)', "\${$first}/{$controller}/\${$second}/\${$third}/\${$fourth}/\${$fifth}/\${$sixth}", $filter);
		self::any($name.'/(:any)/(:any)/(:any)/(:any)/(:any)', "\${$first}/{$controller}/\${$second}/\${$third}/\${$fourth}/\${$fifth}", $filter);
		self::any($name.'/(:any)/(:any)/(:any)/(:any)', "\${$first}/{$controller}/\${$second}/\${$third}/\${$fourth}", $filter);
		self::any($name.'/(:any)/(:any)/(:any)', "\${$first}/{$controller}/\${$second}/\${$third}", $filter);
		self::any($name.'/(:any)/(:any)', "\${$first}/{$controller}/\${$second}", $filter);
		self::any($name.'/(:any)', "\${$first}/{$controller}", $filter);
